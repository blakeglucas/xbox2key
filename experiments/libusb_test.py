...
#     print(0, usb.init(None))
#     dev_handle = usb.open_device_with_vid_pid(None, 0x045e, 0x0b00)
#     print(dev_handle)
#     dev = usb.get_device(dev_handle)
#     print(dev)
#     print(usb.reset_device(dev_handle))
#     # print(1, usb.set_configuration(dev_handle, 0))
#     # print(2, usb.claim_interface(dev_handle, 1))
#     while True:
#         try:
#             time.sleep(0.1)
